...
| baseModule                      | Set the base module namespace                                                                                                 |          | Argo                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | argo                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | ArgoConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | ArgoRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| Argo.Client    | use the "dispatch" functions to send requests       |
| Argo.Core      | core funcions, config and request types             |
| Argo.API       | construct api requests                              |
| Argo.Model     | describes api models                                |
| Argo.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| Argo.ModelLens | lenses for model fields                             |
| Argo.Logging   | logging functions and utils                         |
